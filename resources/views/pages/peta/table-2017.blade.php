				...
				<div class="row" style="padding:20px;">
                    <table class="table table-basic table-striped table-data" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" colspan="{{(count($kejadian)-1)}}">Klasifikasi Potensi Kerawanan</th>
                    ...
                    @foreach ($provinsi as $item)
                            <tr>
                                ...
                                @foreach ($kejadian as $idx=> $itm)
                                <td class="text-center">
                                    @if (isset($jumlah[$item->name][$idx]))
                                        <span style="font-weight: 600;font-size:11px;border-radius:10px" data-title="Jumlah Kejadian" class="label label-info tooltips">{{$jumlah[$item->name][$idx]}}
                                        </span>
                                    @else
                                        -
                                    @endif
