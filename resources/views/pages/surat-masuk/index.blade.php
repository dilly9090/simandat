...
@section('title')
    <title>Surat Masuk - SIMANDAT</title>
@endsection
            ...
            <div class="container-fluid">
				...
				@foreach ($data as $item)
                        <tr>
                            ...
                            <td class="">{{date('d/m/Y',strtotime($item->tgl_masuk))}}</td>
                            ...
                            <td class="">
                                    ...
                                    <a href="{{url('surat-masuk/'.$item->id)}}" class="btn btn-xs btn-flat border-info text-info btn-delete btn-rounded btn-icon">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">	
                                    ...
                                    <div class="input-group">
										<span class="input-group-addon"><i class="icon-calendar5"></i></span>
                                        <input type="text" name="tgl_masuk" class="form-control pickadate" value="{{date('d-m-Y')}}" placeholder="Tanggal Masuk">
									</div>
                                </div>  
						...
						<div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">	
                                    ...
                                    <div class="input-group">
										<span class="input-group-addon"><i class="icon-calendar5"></i></span>
										<input type="text" name="tgl_masuk" id="tgl_masuk" class="form-control pickadate" placeholder="Tanggal Masuk">
									</div>
                                </div>  
...
@section('footscript')
    ...
    $(document).ready(function(){
        ...
        $('#table').on('click', '.btn-edit', function(){
			...
			$.ajax({
                ...
                success: function(res) {
					$('#form-update').attr('action', "{{ url('surat-masuk') }}/"+id)
					$('#nip').val(res.nip);
                    if(res.tgl_masuk!=null)
                    {
                        var tgl=(res.tgl_masuk).split('-');
                        $('#tgl_masuk').val(tgl[2]+'-'+tgl[1]+'-'+tgl[0]);
                    }
        ...
        $('#table').on('click', '.btn-delete', function(){
            var id = $(this).data('value')
			$('#form-delete').attr('action', "{{ url('surat-masuk') }}/"+id)			
        })
