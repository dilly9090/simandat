...
@section('title')
    <title>Detail Surat Keluar - SIMANDAT</title>
@endsection
...
<div class="row">
    ...
    @endif
    <div class="col-md-12">
        <a href="{{url('surat-keluar')}}" class="btn btn-xs btn-success pull-right">< Kembali</a>
    </div>
	<div class="col-lg-12">
		<!-- Traffic sources -->
		<div class="panel panel-flat" style="min-height:350px !important;">
			<div class="panel-heading">
                <h3 class="panel-title">Detail Surat Keluar</h3>    
            </div>
            ...
            <div class="container-fluid" style="padding:0 20px;">
                <form action="{{url("disposisi-surat-keluar")}}" method="POST" enctype="multipart/form-data">
                        @csrf
